        ...
        return isTablet() ?
            ...
            <ImageBackground
                style={[styles.imageCard, {
                    ...
                    marginLeft: this.state.isPortrait ? heightCard * 0.03 : widthCard * 0.07,
                    marginBottom: this.state.isPortrait ? widthCard * 0.05 : heightCard * 0.05,
                    justifyContent: "center",
                    alignItems: "center",
                }]}
                ...
                <TouchableOpacity style={[styles.container, {
                    ...
                    <View style={{
                        ...
                        <View style={{
                            ...
                            backgroundColor: "#35ABEB",
                            borderRadius: width * 0.03,
                            left: this.state.isPortrait ? 0.05 * widthCard : 0.01 * widthCard
                        }}>
                        </View>
                        <View style={{
                            width: this.state.isPortrait ? widthCard * 0.04 : widthCard * 0.04,
                            ...
                            backgroundColor: "#35ABEB",
                            borderRadius: width * 0.03,
                            right: this.state.isPortrait ? 0.07 * widthCard : 0.035 * widthCard
                        }}></View>
                    </View>
                    ...
                    <View style={{
                        ...
                        <Text style={[styles.text, {
                            fontSize: this.state.isPortrait ? 0.022 * width / 2 : 0.025 * width / 2,
                            top: this.state.isPortrait ? -0.001 * widthCard : -0.02 * heightCard
                        }]}>{item.name}</Text>

                        <View style={{}}>
                            <Image style={[styles.imageLesson, {
                                width: this.state.isPortrait ? heightCard * 0.55 : widthCard * 0.75,
                                height: this.state.isPortrait ? widthCard * 0.45 : heightCard * 0.38,
                                top: this.state.isPortrait ? -0.03 * widthCard : -0.01 * heightCard,
                                // left: this.state.isPortrait ? 0.05 * widthCard : 0,
                                paddingHorizontal: this.state.isPortrait ? 0.05 * widthCard : 0,
                            }]}
                                source={item.imageUrl} />
                    ...
                    <View style={{
                        width: this.state.isPortrait ? heightCard * 0.095 : widthCard * 0.1,
                        height: this.state.isPortrait ? heightCard * 0.1 : widthCard * 0.1,
                        borderRadius: this.state.isPortrait ? width * 0.007 : width * 0.005,
                        top: this.state.isPortrait ? -0.03 * widthCard : -0.01 * heightCard,
                        left: this.state.isPortrait ? 0.06 * heightCard : 0.06 * widthCard,
